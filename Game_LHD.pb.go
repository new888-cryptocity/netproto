...
const (
	LHD_GameMessageClassID_LHDSettingID             LHD_GameMessageClassID = 10001 //設定相關 S2C
	LHD_GameMessageClassID_LHDStateID               LHD_GameMessageClassID = 10002 //階段ID S2C
	LHD_GameMessageClassID_LHDBetID                 LHD_GameMessageClassID = 10003 //下注ID C2S
	LHD_GameMessageClassID_LHDBroadCastBetID        LHD_GameMessageClassID = 10004 //廣播下注 S2C
	LHD_GameMessageClassID_LHDGameResultPokerID     LHD_GameMessageClassID = 10005 //遊戲結果撲克 S2C
	LHD_GameMessageClassID_LHDGameSceneID           LHD_GameMessageClassID = 10006 //遊戲場景 斷線重連
	LHD_GameMessageClassID_LHDGameResultWinID       LHD_GameMessageClassID = 10007 //遊戲結果贏錢 S2C
	LHD_GameMessageClassID_LHDBetInfoID             LHD_GameMessageClassID = 10008 //用戶斷線重連已下注的消息
	LHD_GameMessageClassID_LHDBetRetID              LHD_GameMessageClassID = 10009 //下注結果 S2C
	LHD_GameMessageClassID_LHDShangZhuangID         LHD_GameMessageClassID = 10010 //上莊請求 C2S
	LHD_GameMessageClassID_LHDShangZhuangRetID      LHD_GameMessageClassID = 10011 //上莊請求結果 S2C
	LHD_GameMessageClassID_LHDGetShangZhuangListID  LHD_GameMessageClassID = 10012 //獲取上莊列表 C2S
	LHD_GameMessageClassID_LHDShangZhuangListInfoID LHD_GameMessageClassID = 10013 //下發上莊列表 S2C
	LHD_GameMessageClassID_LHDZhuangInfoID          LHD_GameMessageClassID = 10014 //莊家信息 S2C
	LHD_GameMessageClassID_LHDBetClearID            LHD_GameMessageClassID = 10015 //玩家清除已下的注 C2S
	LHD_GameMessageClassID_LHDResultCardListID      LHD_GameMessageClassID = 10016 //前20次開牌結果
	LHD_GameMessageClassID_LHDBetClearRetID         LHD_GameMessageClassID = 10017 //清理下注結果
	LHD_GameMessageClassID_LHDEnterGameUserRank     LHD_GameMessageClassID = 10018 //進入遊戲時玩家金幣排名TOP6 S2C
	LHD_GameMessageClassID_LHDGameResultOneUserWin  LHD_GameMessageClassID = 10019 //結算後需要顯示輸贏的列表
	LHD_GameMessageClassID_LHDBroadCastZhuangList   LHD_GameMessageClassID = 10020 //廣播莊列表 S2C
	LHD_GameMessageClassID_LHDBetHistoryListID      LHD_GameMessageClassID = 10021 //投注曆史排行 S2C GameUserBetHistroyRand
	LHD_GameMessageClassID_LHDTableInfo             LHD_GameMessageClassID = 10022 //桌子信息
)
...
var (
	LHD_GameMessageClassID_name = map[int32]string{
		...
		10018: "LHDEnterGameUserRank",
		10019: "LHDGameResultOneUserWin",
		10020: "LHDBroadCastZhuangList",
		10021: "LHDBetHistoryListID",
		10022: "LHDTableInfo",
	}
	LHD_GameMessageClassID_value = map[string]int32{
		...
		"LHDEnterGameUserRank":     10018,
		"LHDGameResultOneUserWin":  10019,
		"LHDBroadCastZhuangList":   10020,
		"LHDBetHistoryListID":      10021,
		"LHDTableInfo":             10022,
	}
)
...
var file_Game_LHD_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x6e, 0x65, 0x74, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2a, 0x9d, 0x04, 0x0a, 0x16, 0x4c,
	...
	,
}
